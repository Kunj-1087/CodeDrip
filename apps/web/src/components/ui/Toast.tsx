      ...
      <AnimatePresence>
        {toasts.map((t) => (
          <motion.div
            ...
            className={cn(
              'group pointer-events-auto relative overflow-hidden rounded-lg border border-border bg-surface pl-4 pr-3 py-3.5 shadow-xl',
          ...
          >
            ...
            <motion.span
              ...
              className={cn('absolute bottom-0 left-0 h-0.5 w-full origin-left', ACCENT[t.type])}
